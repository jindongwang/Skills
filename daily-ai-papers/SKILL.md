...
- Unified Multimodal Models: unified multimodal models, multimodal foundation models, MLLMs, VLMs, multimodal agents, cross-modal alignment, multimodal benchmarks/evaluations.
